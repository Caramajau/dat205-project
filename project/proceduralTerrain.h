...
public:
	...
	void setGpuData(int seed, int perlinWidth, int perlinHeight, int gridSize, int octaveCount, float lacunarity, float persistence, InterpolationType interpolationType, int warpLevel, float initialHeightScale);
